...
```{r}
df = data.frame(complete = c(0.0, 0.0, 0.0), AIC = c(0.0,0.0, 0.0))
rownames(df) = c("DeltaT", "DeltaC", "ATE")


df %>%
  conversion_latex(nom = "reg_trim_test_predictions",
                   caption = "Mesure de qualité d'estimation par ensemble sous espace tronqué")
```
